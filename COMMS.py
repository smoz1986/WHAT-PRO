...
def runShellScript6():
	import subprocess
	subprocess.call(['/root/WHAT-PRO/./WIFI-BOOST.sh'])
...
def runShellScript7():
	import subprocess
	subprocess.call(['/root/WHAT-PRO/./GPS-LAUNCH.sh'])
...
def runShellScript8():
	import subprocess
	subprocess.call(['/root/WHAT-PRO/./OVPN-LAUNCH.sh'])
...
#	import subprocess
#	subprocess.call(['/root/WHAT-PRO/./WPA-SUP-LAUNCH.sh'])

#btn_dad = Button( window , text = 'WiFi AP Connect' , command=runShellScript10 , width = 15 )
#btn_dad.grid(row=4,column=0)
